...
- [ ] Explain what a token is used for.
      ...
      A token is used to authorize a user to view certain pages (e.g. their dashboard once they're logged in)

- [ ] What steps can you take in your web apps to keep your data secure?

      Create private routes. Keep sensitive data on the backend

- [ ] Describe how web servers work.

      Web servers provide data to other computers in response to HTTP requests
